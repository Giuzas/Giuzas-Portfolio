<template>
  <div>
    <v-navigation-drawer v-model="drawer" absolute temporary app width="150" height="340">
      <v-list class="pt-4">
        <v-list-tile active-class="orange--text" to="/">
          <v-list-tile-content>
        ...
        <v-list-tile active-class="orange--text" to="/services">
          <v-list-tile-content>
        ...
        <v-list-tile active-class="orange--text" to="/blog">
          <v-list-tile-content>
    ...
    <v-toolbar flat dense color="transparent" scroll-off-screen>
      ...
      <v-toolbar-title class="headline">
        <span class="font-weight-light">Giuseppe</span>
      ...
      <v-toolbar-items class="hidden-sm-and-down">
        ...
        <v-btn flat to="/services" active-class="orange--text headline">Services</v-btn>
        <v-btn flat to="/portfolio" active-class="orange--text headline">Portfolio</v-btn>
        <v-btn flat to="/blog" active-class="orange--text headline">Blog</v-btn>
